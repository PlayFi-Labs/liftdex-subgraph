...
export const FACTORY_ADDRESS = '0x6263415D804eA3777B6E0B2722D80905aBDcb7Cc'
...
export function address2string(addr: Address): string {
  return addr.toHex().toLowerCase();
}
